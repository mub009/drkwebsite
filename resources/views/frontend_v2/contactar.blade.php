        ...
        <div class="team-container">
            <div class="team-header">
                ...
                <h1 class="hero-title" style="text-align: center;">
                    <span class="headline-emphasis">تواصل مع مستشفى الدكتور خالد الرويـمي اليوم</span>
                </h1>

                <p class="hed_des">
                    هل لديك أسئلة أو تحتاج إلى رعاية؟ تواصل معنا الآن واحجز استشارتك مع نخبة الأطباء الخبراء. نحن
                    هنا لمساعدتك.
                </p>
...
<section class="section" style="margin-top: 50px !important;" dir="rtl">
    <div class="containerz">
        <div class="form-map-wrapper">

            <div class="contact-info-card">
                <h2 class="contact-title">خيارات الاتصال</h2>

                <ul class="contact-list">
                    <li>
                        <i class="fas fa-map-marker-alt"></i>
                        <h3 class="feature-title"> المملكة العربية السعودية – شارع الأمير محمد بن فهد</h3>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <a href="https://wa.me/966138955555" target="_blank" class="whatsapp-btn">الدردشة عبر
                            واتساب</a>
                    </li>
                    <li>
                ...
                <h3 class="feature-title" style="margin-bottom: 20px;">ساعات العمل</h3>
                <ul class="hours-title">
                    <li><strong>السبت – الخميس:</strong> 9:00 صباحاً – 10:00 مساءً</li>
